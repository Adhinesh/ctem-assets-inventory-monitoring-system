...
CREATE TABLE vulnerabilities (
    ...
    -- CVE Identity
    cve_id              VARCHAR(128)    UNIQUE,             -- "CVE-2024-1234" or scanner template ID
...
-- ================================================================
-- XFinder compatibility layer
-- ------------------------------------------------
-- Team 1's scan bundle can be stored here without losing its native
-- structure. These tables mirror the upstream normalized schema and
-- keep raw scan/change reports for import or replay.
-- ================================================================
